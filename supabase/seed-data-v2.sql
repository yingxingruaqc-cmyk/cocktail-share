-- Cocktails App 示例数据 v2
-- 10个经典鸡尾酒配方（包含新字段）
-- 使用方法：
-- 1. 先注册一个用户
-- 2. 从 profiles 表中获取该用户的 ID
-- 3. 替换下面所有的 '你的用户ID' 为实际的用户 ID
-- 4. 在 SQL Editor 中运行

-- 首先确保你有一个用户 profile
-- 如果没有，可以先插入一个（替换为你的用户 ID）
-- INSERT INTO profiles (id, username, avatar_url, bio)
-- VALUES ('你的用户ID', '鸡尾酒大师', null, '热爱调酒，分享经典配方')
...
-- 1. 曼哈顿
('你的用户ID', '曼哈顿', 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800', '古典', '威士忌', '{"焦糖","草本"}', '顺滑', '经典的曼哈顿鸡尾酒，威士忌与甜苦艾酒的完美结合',
...
-- 2. 尼格罗尼
('你的用户ID', '尼格罗尼', 'https://images.unsplash.com/photo-1536935338788-846bb9981813?w=800', '古典', '金酒', '{"草本","焦糖"}', '顺滑', '意大利经典鸡尾酒，金酒、甜苦艾酒与金巴利的完美平衡',
...
-- 3. 干马天尼
('你的用户ID', '干马天尼', 'https://images.unsplash.com/photo-1575023782549-62ca0d244b39?w=800', '古典', '金酒', '{"草本"}', '清爽', '007的最爱，最经典的鸡尾酒之一',
...
-- 4. 威士忌酸
('你的用户ID', '威士忌酸', 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=800', '酸酒', '威士忌', '{"果香"}', '酸口', '清爽酸甜的经典威士忌鸡尾酒',
...
-- 5. 旧时尚
('你的用户ID', '旧时尚', 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800', '古典', '威士忌', '{"焦糖","草本"}', '顺滑', '最古老的鸡尾酒之一，简单而优雅',
...
-- 6. 莫斯科骡子
('你的用户ID', '莫斯科骡子', 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=800', '酸酒', '伏特加', '{"果香","薄荷"}', '清爽', '伏特加与姜汁啤酒的清爽组合',
...
-- 7. 边车
('你的用户ID', '边车', 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=800', '酸酒', '白兰地', '{"果香"}', '酸口', '干邑与橙味利口酒的经典组合',
...
-- 8. 吉姆雷特
('你的用户ID', '吉姆雷特', 'https://images.unsplash.com/photo-1560512823-829485b8bf24?w=800', '酸酒', '金酒', '{"果香"}', '清爽', '简单清爽的金酒鸡尾酒',
...
-- 9. 飞天海马
('你的用户ID', '飞天海马', 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=800', '提拉', '朗姆', '{"咖啡","奶油"}', '绵密', '层次分明的经典提拉鸡尾酒',
...
-- 10. 长岛冰茶
('你的用户ID', '长岛冰茶', 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=800', '酸酒', '伏特加', '{"果香","焦糖"}', '清爽', '看似温和实则强劲的经典鸡尾酒',
